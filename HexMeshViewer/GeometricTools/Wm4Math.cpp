...
template<> const float Math<float>::ZERO_TOLERANCE = 1e-30f;//pengbo, old value is1e-6
...
template<> const double Math<double>::ZERO_TOLERANCE = 1e-30;//pengbo, old value is1e-8
