...
// Alex add 2 functions in this files
// search for  alex's
...
public:
	...
	static void Orthonormalize (Vector3& rkU, Vector3& rkV); // alex's
	...
	// special operations
	inline void shift()  // alex's
	{
		Real tmp;
		tmp = m_afTuple[2];
		m_afTuple[2] = m_afTuple[1];
		m_afTuple[1] = m_afTuple[0];
		m_afTuple[0] = tmp;
	};
