...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_Strategy_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Strategy_t qt_meta_stringdata_Strategy = {
    {
QT_MOC_LITERAL(0, 0, 8) // "Strategy"
...
QT_INIT_METAOBJECT const QMetaObject Strategy::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_Strategy.data,
    qt_meta_data_Strategy,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *Strategy::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Strategy.stringdata0))
